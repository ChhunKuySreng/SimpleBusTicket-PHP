...
function validateForm(evt)
{
    ...
    const bustypeInput = addBusForm.elements.bustype;
    ...
    if(bustypeInput.value.match(regex))
    {
        evt.preventDefault();
        errorSpan1.innerText = "Bus Type should have capital letters";
    }else{
        errorSpan1.innerText = null;
    }
}
